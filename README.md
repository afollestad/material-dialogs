...
dependencies {
    ...
    implementation 'com.afollestad.material-dialogs:input:2.0.0-alpha12'
}
```
...
dependencies {
    ...
    implementation 'com.afollestad.material-dialogs:files:2.0.0-alpha12'
}
```
...
dependencies {
    ...
    implementation 'com.afollestad.material-dialogs:color:2.0.0-alpha12'
}
```
