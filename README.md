...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:input:3.0.2'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:files:3.0.2'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:color:3.0.2'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:datetime:3.0.2'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:bottomsheets:3.0.2'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:lifecycle:3.0.2'
}
```
