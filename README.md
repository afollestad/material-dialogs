...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:files:2.4.0'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:color:2.4.0'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:lifecycle:2.4.0'
}
```
