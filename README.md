...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:core:3.2.0'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:input:3.2.0'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:files:3.2.0'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:color:3.2.0'
}
```
...
dependencies {
  ...
  implementation 'com.afollestad.material-dialogs:datetime:3.2.0'
}
```
